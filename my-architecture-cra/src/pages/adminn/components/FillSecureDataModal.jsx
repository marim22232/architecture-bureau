...
const FillSecureDataModal = ({ isOpen, onClose, account, onSave }) => {
    ...
    // Загружаем существующие данные при открытии модалки
    useEffect(() => {
        if (isOpen && account) {
            loadExistingData();
        }
    ...
    const loadExistingData = async () => {
        ...
        try {
            ...
            if (result && result.success && result.data) {
                ...
                console.log('📦 Загружены существующие данные:', data);
            }
        } catch (error) {
    ...
    const handleSubmit = async () => {
        setLoading(true);
        try {
            await onSave(account.profile.id, formData);
                ...
                <div className="modal-body">
                    ...
                    {loadingData ? (
                        ...
                        <>
                            ...
                            <div className="form-section">
                                <Typography variant="h4" weight="semibold">📋 Паспортные данные</Typography>
                            ...
                            {/* Адреса */}
                            <div className="form-section">
                                <Typography variant="h4" weight="semibold">📍 Адреса</Typography>
                                <div className="form-row">
                                    <div className="form-group">
                            ...
                            {isTeam ? (
                                ...
                                <>
                                    <div className="form-section">
                                        <Typography variant="h4" weight="semibold">👤 Личная информация</Typography>
                                        <div className="form-row">
                                            <div className="form-group">
                                    ...
                                    <div className="form-section">
                                        <Typography variant="h4" weight="semibold">💼 Трудовые данные</Typography>
                                        <div className="form-row">
                                            <div className="form-group">
                                ...
                                <>
                                    ...
                                    <div className="form-section">
                                        <Typography variant="h4" weight="semibold">💰 Финансовая информация</Typography>
                                        <div className="form-row">
                                            <div className="form-group">
                                                <label>Банковские реквизиты</label>
                                                <MyTextarea 
                    ...
                    <div style={{ background: '#e3f2fd', padding: '12px', borderRadius: '8px', margin: '15px 0' }}>
                        <Typography variant="small">
                            ⚠️ Данные будут зашифрованы. Доступ только у администратора.
                        </Typography>
                    </div>
                </div>
