...
const Icons = {
    ...
    // my-architecture-cra/src/components/UI/Icons/Icons.jsx
    // Добавь в объект Icons:
    ...
    // Человек / Пользователь (для входа, профиля) - коричневый
    ...
    // Человек с круглой головой (альтернативный вариант)
    UserAvatar: ({ className, color = "#8B4513", size = 24 }) => (
        <svg
            width={size}
            height={size}
            viewBox="0 0 24 24"
    ...
    // Вход/выход (дверь со стрелкой)
    Login: ({ className, color = "#8B4513", size = 24 }) => (
        <svg
            width={size}
            height={size}
            viewBox="0 0 24 24"
            ...
            style={{ color }}
        >
            <path d="M10 17l5-5-5-5v3H4v4h6v3zm9-13h-8c-1.1 0-2 .9-2 2v2h2V6h8v12h-8v-2h-2v2c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z" fill="currentColor" />
        </svg>
    ),
    ...
    // Добавьте в Icons.js после Folder или в любое удобное место
    ...
    // Добавь после Folder или в любое место:
...
// Добавь в объект Icons (например, после Heart):
